...
Route::get('/dashboard/vendorbikes', 'App\Http\Controllers\DashboardController@vendorbikes');
Route::get('/dashboard/customerbookings', 'App\Http\Controllers\DashboardController@customerbookings');
Route::get('/dashboard/bookingsdate', 'App\Http\Controllers\DashboardController@bookingsdate');
...
Route::get('/feedback/add/{id}', 'App\Http\Controllers\FeedbackController@add');
Route::post('/feedback/add/{id}', 'App\Http\Controllers\FeedbackController@add');
Route::get('/feedback/delete/{id}', 'App\Http\Controllers\FeedbackController@delete');
Route::post('/feedback/delete/{id}', 'App\Http\Controllers\FeedbackController@delete');
