...
function populate_bikes_table(data)
{
    ...
    else
    {
        ...
        html += '<th width="20%">Bikes Name </th>'; 
        html += '<th width="10%">Color </th>';  
        html += '<th width="15%">Vendor </th>'; 
        html += '<th width="10%">Location </th>'; 
        html += '<th width="10%">Gear Speed </th>'; 
        html += '<th width="15%">Hourly Cost(KES) </th>';
        ...
        $.each( data, function( key, val )
        {
            ...
            html += '<td align="right">' + val.hourly_cost + '</td>';  
            html += '<td align="right"><a href="<?= URL::to('/') ?>/bikes/edit/' + val.id + '" bikes_editid="' + val.id + '" class="btn btn-primary bikes-edit-link">Edit</a> '; 
