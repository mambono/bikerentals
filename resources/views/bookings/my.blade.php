...
function populate_bikes_table(data)
{
    ...
    else
    {
        ...
        html += '<th width="22%">Booked Dates</th>';  
        html += '<th width="10%">Total Hours</th>'; 
        html += '<th width="8%">Cost </th>';
        ...
        $.each( data, function( key, val )
        {
            ...
            html += '<td><a href="<?= URL::to('/') ?>/bookings/delete/' + val.id + '" bikes_editid="' + val.id + '" class="btn btn-danger bikes-delete-link">Delete</a> ';   
