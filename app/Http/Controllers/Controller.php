...
class Controller extends BaseController
{
	...
	public function __construct()
    {
		...
		$this->middleware(function ($request, $next) 
		{
			...
			{
				if((strtolower($controller_name) == 'applicationscontroller' ) || (strtolower($controller_name) == 'homecontroller' )  || (strtolower($controller_name) == 'registercontroller' ) || (strtolower($controller_name) == 'bookingscontroller' ) || (strtolower($controller_name) == 'feedbackcontroller' ) || (strtolower($controller_name) == 'logoutcontroller' ))
				{
					$accessible = 1;
				}  
			}
