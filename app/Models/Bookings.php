...
class Bookings extends Model
{
	...
	{
			$sql = Bikes::select('bike_bookings.id',     'bikes.short_name', 'bikes.color', 'bikes.hourly_cost', 'bikes.size','bikes.electric', 'bikes.gear_speed', 'cities.city', 'bike_bookings.start_date', 'bike_bookings.end_date', 'vendors.vendor_name', DB::raw('CONCAT(users.first_name, " ", users.last_name) AS full_name') )
	...
	{
		$sql = Bikes::select('bike_bookings.id',   'bikes.city_id', 'bikes.vendor_id', 'bikes.short_name', 'bikes.color', 'bikes.hourly_cost', 'bikes.size', 'cities.city', 'bike_bookings.start_date', 'bike_bookings.end_date', 'vendors.vendor_name', DB::raw('CONCAT(users.first_name, " ", users.last_name) AS full_name'))
		->join('cities', 'bikes.city_id', '=', 'cities.id') 
		->join('bike_bookings', 'bike_bookings.bike_id', '=', 'bikes.id')  
		->join('vendors', 'vendors.id', '=', 'bikes.vendor_id')  
		->join('users', 'bike_bookings.booked_by', '=', 'users.id')    
	...
	{
		$sql = Bikes::select('bike_bookings.id',   'bikes.city_id', 'bikes.vendor_id', 'bikes.short_name', 'bikes.color', 'bikes.hourly_cost', 'bikes.size', 'cities.city', 'bike_bookings.start_date', 'bike_bookings.end_date', 'vendors.vendor_name')
		->join('cities', 'bikes.city_id', '=', 'cities.id') 
		->join('bike_bookings', 'bike_bookings.bike_id', '=', 'bikes.id') 
		->join('vendors', 'vendors.id', '=', 'bikes.vendor_id')   
